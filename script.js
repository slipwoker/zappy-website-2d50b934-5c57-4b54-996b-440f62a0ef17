    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "L&M משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '2d50b934-5c57-4b54-996b-440f62a0ef17',
                    name: data.name || '',
                    email: data.email || '',
